...
<div id="sidebar">
    <h2 class="mb-4">Corredor Menu</h2>
    <ul class="nav flex-column">
        <li class="nav-item">
            <a class="nav-link" href="corredor/apuntarse">Apuntarse</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="corredor/carreras-disponibles">Carreras disponibles</a>
        </li>
        <li class="nav-item">
            <a class="nav-link" href="corredor/mis-carreras">Mis carreras</a>
        </li>
    </ul>
...
<div id="content">
    <header class="mb-5">
        ...
        <h1 class="text-center">Panel de Corredor</h1>
    </header>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        console.log('Pagina corredor cargada');
    });
</script>
</body>
</html>